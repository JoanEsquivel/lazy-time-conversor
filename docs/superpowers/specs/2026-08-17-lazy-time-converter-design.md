...
Release 1 ships **every country and territory in the tz database (247), grouped by continent (Africa, Americas, Asia, Europe, Oceania)**, with a searchable picker. Costa Rica, United States, India and Philippines remain the reference cases for tests.
...
| Countries | **All 247** tz countries/territories · continents Africa · Americas · Asia · Europe · Oceania (Antarctica excluded) |
